...
const policySections = [
  ...
  },
  {
    ...
    paragraphs: [
      "本サービスでは、サービスの提供および改善に必要な範囲でOpenFreeMap、OpenMapTiles、OpenStreetMapとVercelを利用しています。OpenFreeMapは地図表示のために利用し、地図表示時には利用者のブラウザから直接通信します。Vercelはホスティング、コンテンツ配信、セキュリティ、障害調査、利用状況および性能の把握に利用します。",
      "本サービスの運営者が、OpenFreeMap、OpenMapTilesまたはOpenStreetMap側で取得された情報を独自に取得または保存することはありません。",
    ],
  ...
  },
  {
    title: "9. お問い合わせ",
    paragraphs: [
      "このプライバシーポリシーに関するお問い合わせは、Irish Pub Map の公開リポジトリの Issue からお願いします。個別のログやOpenFreeMap、OpenMapTilesまたはOpenStreetMap側の記録については、提供者の方針により対応できない場合があります。",
    ],
  },
];
