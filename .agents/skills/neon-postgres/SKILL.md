...
If the `neon` skill is not installed, fetch it from https://github.com/neondatabase/agent-skills/tree/main/skills/neon/SKILL.md or install it with:
...
For detailed branch creation workflows (normal vs schema-only branches, reset-from-parent, CLI/MCP selection), use the `neon-postgres-branches` skill. If it isn't installed, fetch it from https://github.com/neondatabase/agent-skills/tree/main/skills/neon-postgres-branches/SKILL.md or install it with:
